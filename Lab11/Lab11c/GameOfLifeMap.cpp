//LAB 11c: Apply The STL map Template To The Classic Game Of Life Simulation
...
int main()
{
  cout << "LAB 11c: Apply The STL map Template To The Classic Game Of Life Simulation b\n";
